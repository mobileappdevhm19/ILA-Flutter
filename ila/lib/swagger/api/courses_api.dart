...
class CoursesApi {
  ...
  Future<MultipartFile> coursesGenerateToken({ int courseId }) async {
    ...
    // create path and map variables
    String path = "/api/Courses/generateToken".replaceAll("{format}","json");
    ...
    Map<String, String> formParams = {};
    if(courseId != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "courseId", courseId));
    }
  ...
  Future<Course> coursesGetMemberCourse(int id) async {
    ...
    // create path and map variables
    String path = "/api/Courses/member/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<Course> coursesGetOwnerCourse(int id) async {
    ...
    // create path and map variables
    String path = "/api/Courses/owner/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<MultipartFile> coursesJoinCourse({ int courseId, String token }) async {
    ...
    // create path and map variables
    String path = "/api/Courses/join".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<MultipartFile> coursesPutCourse(int id, CourseCreateUpateModel courseModel) async {
    Object postBody = courseModel;
