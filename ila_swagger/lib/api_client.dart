...
class ApiClient {
  ...
  ApiClient({this.basePath: "https://ila.dev.kirschbaum.bayern"}) {
    ...
    _authentications['JWT'] = new ApiKeyAuth("header", "Authorization");
  }
  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'AnswerCreate':
          return new AnswerCreate.fromJson(value);
        case 'Course':
          return new Course.fromJson(value);
        case 'CourseMember':
          return new CourseMember.fromJson(value);
        case 'CourseNews':
          return new CourseNews.fromJson(value);
        case 'CourseToken':
        ...
        case 'SavePushToken':
          return new SavePushToken.fromJson(value);
        case 'SignIn':
          return new SignIn.fromJson(value);
        case 'SignUp':
          return new SignUp.fromJson(value);
        case 'TestPush':
          return new TestPush.fromJson(value);
        case 'IdentityUser':
